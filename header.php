  ...
  <header class="r9-studio-bar">
    <div class="r9-wrap r9-studio-bar-inner">
      ...
      <div class="r9-header-tools">
        ...
        <div class="r9-header-risk <?php echo esc_attr(r9_risk_class()); ?>" aria-label="Current Region 9 risk level">
          <span class="r9-header-risk-dot" aria-hidden="true"></span>
          <span class="r9-header-risk-copy"><small>Risk Level</small><strong><?php echo esc_html(r9_risk_label()); ?></strong></span>
        </div>
      </div>
    </div>
  </header>
