...
define('R9LS_VERSION', '17.0.0-rc.2');
...
require_once R9LS_DIR . 'includes/class-graphics-engine.php';
...
final class R9LS_Plugin {
    ...
    private function __construct() {
        ...
        $this->graphics = new R9LS_Graphics_Engine($this->audit);
        $this->products = new R9LS_Product_Generator($this->rules, $this->changes, $this->audit, $this->timing, $this->graphics);
    ...
    public static function activate() { self::instance()->scheduler->activate(); }
    public static function deactivate() { self::instance()->scheduler->deactivate(); }
}
