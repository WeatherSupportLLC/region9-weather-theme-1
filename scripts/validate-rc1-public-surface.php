...
pass('major public Live Studio CSS remains additive', strpos($style, '.r9ls-product-card') !== false && strpos($style, 'Region 9 Live Studio Alpha 8 canonical product components') !== false);
...
$report = array('passes'=>$passes,'generated_at'=>date('c'),'scope'=>'RC1 Step 1 public surface preservation guardrails','reference_note'=>'No v15/v15.1 reference ZIP is present in this checkout; this static suite guards the preserved GeneratePress child-theme surface currently available in the repository.');
...
echo "RC1 public surface validation complete with $passes assertions.\n";
