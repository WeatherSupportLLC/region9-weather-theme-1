...
$report = array('passes'=>$passes,'generated_at'=>date('c'),'baseline'=>'v15/v15.1 artifacts unavailable; current RC1 inventory guarded','purpose'=>'Fail if required pages, menus, sidebars, placeholders, admin pages, REST routes, theme relationship, or inventory docs disappear.');
